...
public class SolBlocks 
{
	...
	public static final Block MERCURY_ALUMINUM_ORE = new BlockBase("mercury_aluminum_ore", Material.ROCK, "pickaxe", 1, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(8F);
	public static final Block MERCURY_COPPER_ORE = new BlockBase("mercury_copper_ore", Material.ROCK, "pickaxe", 1, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(8F);
	...
	public static final Block MERCURY_IRON_ORE = new BlockBase("mercury_iron_ore", Material.ROCK, "pickaxe", 1, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(8F);
	...
	public static final Block MERCURY_TIN_ORE = new BlockBase("mercury_tin_ore", Material.ROCK, "pickaxe", 1, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(8F);
	...
	public static final Block IO_ALUMINUM_ORE = new BlockBase("io_aluminum_ore", Material.ROCK, "pickaxe", 0, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(6F);
	public static final Block IO_COPPER_ORE = new BlockBase("io_copper_ore", Material.ROCK, "pickaxe", 0, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(6F);
	public static final Block IO_IRON_ORE = new BlockBase("io_iron_ore", Material.ROCK, "pickaxe", 0, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(6F);
	...
	public static final Block EUROPA_ALUMINUM_ORE = new BlockBase("europa_aluminum_ore", Material.ROCK, "pickaxe", 0, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(6F);
	public static final Block EUROPA_COPPER_ORE = new BlockBase("europa_copper_ore", Material.ROCK, "pickaxe", 0, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(6F);
	public static final Block EUROPA_IRON_ORE = new BlockBase("europa_iron_ore", Material.ROCK, "pickaxe", 0, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(6F);
	//saturn
	...
	public static final Block MIMAS_COPPER_ORE = new BlockBase("mimas_copper_ore", Material.ROCK, "pickaxe", 1, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(8F);
	...
	public static final Block MIMAS_IRON_ORE = new BlockBase("mimas_iron_ore", Material.ROCK, "pickaxe", 1, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(8F);
	public static final Block MIMAS_MAGANESE_ORE = new BlockBase("mimas_manganese_ore", Material.ROCK, "pickaxe", 0, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(6F);
	public static final Block MIMAS_TIN_ORE = new BlockBase("mimas_tin_ore", Material.ROCK, "pickaxe", 1, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(8F);
	//titan
	...
	public static final Block TITAN_ALUMINUM_ORE = new BlockBase("titan_aluminum_ore", Material.ROCK, "pickaxe", 1, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(8F);
	...
	public static final Block ARIEL_ALUMINUM_ORE = new BlockBase("ariel_aluminum_ore", Material.ROCK, "pickaxe", 1, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(8F);
	...
	public static final Block ARIEL_IRON_ORE = new BlockBase("ariel_iron_ore", Material.ROCK, "pickaxe", 1, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(8F);
	...
	public static final Block ARIEL_LITHOS_ORE = new BlockBase("ariel_lithos_ore", Material.ROCK, "pickaxe", 0, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(6F);
	public static final Block ARIEL_TIN_ORE = new BlockBase("ariel_tin_ore", Material.ROCK, "pickaxe", 1, TheSol.BLOCK_TAB).setHardness(3.5F).setResistance(8F);
