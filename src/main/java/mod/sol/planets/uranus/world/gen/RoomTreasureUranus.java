            ...
            for (int j = 0; j <= this.sizeY; j++)
            {
                for (int k = 0; k <= this.sizeZ; k++)
                {
                    ...
                    else if (i == this.sizeX / 2 && j == 1 && k == this.sizeZ / 2)
                    {
                        ...
                        {
                            worldIn.setBlockState(blockpos, SolBlocks.TREASURE_CHEST_T7.getDefaultState().withProperty(BlockTier6TreasureChest.FACING, this.getDirection().getOpposite()), 2);
