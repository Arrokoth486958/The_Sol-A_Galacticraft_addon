package mod.sol.planets.jupiter;
...
public class JupiterModuleClient implements IPlanetsModuleClient {
    @Override
    ...
    {
        ModelResourceLocation modelResourceLocation = new ModelResourceLocation(Reference.MOD_ID + ":" + "rocket_t5", "inventory");
        //ModelResourceLocation modelResourceLocation = new ModelResourceLocation("galacticraftplanets:rocket_t3", "inventory");
        for (int i = 0; i < 5; ++i)
        {
            ModelLoader.setCustomModelResourceLocation(SolItems.ROCKET_T5, i, modelResourceLocation);
        }
    }
    ...
    {
        JupiterModuleClient clientEventHandler = new JupiterModuleClient();
